...
# note: originally i didn't havethe {} but stupid google put a AI generating
thing on the seach results.
# It said this was better, but just wanted to note this. I turned it off for
future.
...
print("/nThe first letter in each name would spell: " + acronym)
'''
Refernces:
